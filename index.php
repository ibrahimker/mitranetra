 ...
 */
get_header(); ?>
<a href="#caribuku" class="sr-only">Skip to Search Form</a>
<div id="fullpage">
                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                        ...
                        <div class="wow bounceInUp" data-wow-delay="0.9s">
                            <form id="caribuku" action="<?php echo home_url( '/' ); ?>" method="get" class="form-inline" role="search">
                                <fieldset>
